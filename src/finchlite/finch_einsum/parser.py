...
nary_ops = {
    ...
    "min": operator.promote_min,
    "max": operator.promote_max,
    "logaddexp": operator.logaddexp,
}
...
unary_ops = {
    ...
    "not": operator.logical_not,
    "logical_not": operator.logical_not,
    "abs": operator.abs,
    "absolute": operator.abs,
    "sqrt": operator.sqrt,
    "exp": operator.exp,
    "log": operator.log,
    "log1p": operator.log1p,
    ...
    "cosh": operator.cosh,
    "tanh": operator.tanh,
    "asin": operator.arcsin,
    "arcsin": operator.arcsin,
    "acos": operator.arccos,
    "arccos": operator.arccos,
    "atan": operator.arctan,
    "arctan": operator.arctan,
    "asinh": operator.arcsinh,
    "arcsinh": operator.arcsinh,
    "acosh": operator.arccosh,
    "arccosh": operator.arccosh,
    "atanh": operator.arctanh,
    "arctanh": operator.arctanh,
}
...
reduction_ops = {
    ...
    "prod": operator.mul,
    "and": operator.logical_and,
    "all": operator.logical_and,
    "or": operator.logical_or,
    "any": operator.logical_or,
    "min": operator.promote_min,
    "minimum": operator.promote_min,
    "max": operator.promote_max,
    "maximum": operator.promote_max,
    "&": operator.and_,
    "bitwise_and": operator.and_,
    "|": operator.or_,
    "bitwise_or": operator.or_,
