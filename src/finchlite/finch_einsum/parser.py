...
nary_ops = {
    ...
    "/": ffunc.truediv,
    "div": ffunc.truediv,
    "divide": ffunc.truediv,
    "//": ffunc.floordiv,
    "fld": ffunc.floordiv,
    "floor_divide": ffunc.floordiv,
    "%": ffunc.mod,
    "mod": ffunc.mod,
    "remainder": ffunc.mod,
    "**": ffunc.pow,
    ...
    ">=": ffunc.ge,
    "ge": ffunc.ge,
    "greater_equal": ffunc.ge,
    "&": ffunc.and_,
    "bitwise_and": ffunc.and_,
    "|": ffunc.or_,
    "bitwise_or": ffunc.or_,
    "^": ffunc.xor,
    "bitwise_xor": ffunc.xor,
    "<<": ffunc.lshift,
    "lshift": ffunc.lshift,
    "bitwise_left_shift": ffunc.lshift,
    ">>": ffunc.rshift,
    "rshift": ffunc.rshift,
    "bitwise_right_shift": ffunc.rshift,
    "and": ffunc.logical_and,
    "or": ffunc.logical_or,
    "not": ffunc.logical_not,
    "min": ffunc.promote_min,
    "max": ffunc.promote_max,
    "logaddexp": ffunc.logaddexp,
}
...
unary_ops = {
    ...
    "~": ffunc.invert,
    "invert": ffunc.invert,
    "bitwise_invert": ffunc.invert,
    "not": ffunc.logical_not,
    "logical_not": ffunc.logical_not,
    "abs": ffunc.abs,
    "absolute": ffunc.abs,
    "sqrt": ffunc.sqrt,
    "exp": ffunc.exp,
    ...
    "arctan": ffunc.arctan,
    "asinh": ffunc.arcsinh,
    "arcsinh": ffunc.arcsinh,
    "acosh": ffunc.arccosh,
    "arccosh": ffunc.arccosh,
    "atanh": ffunc.arctanh,
    "arctanh": ffunc.arctanh,
}
...
reduction_ops = {
    ...
    "prod": ffunc.mul,
    "and": ffunc.logical_and,
    "all": ffunc.logical_and,
    "or": ffunc.logical_or,
    "any": ffunc.logical_or,
    "min": ffunc.promote_min,
    "minimum": ffunc.promote_min,
    "max": ffunc.promote_max,
    "maximum": ffunc.promote_max,
    "&": ffunc.and_,
    "bitwise_and": ffunc.and_,
    "|": ffunc.or_,
    "bitwise_or": ffunc.or_,
