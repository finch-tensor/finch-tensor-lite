...
class RandomRead(SequentialRead):
    """
    Supports O(1) access for any index / key. Falls back to sequential read in last resort
    """

class RandomWrite:
    """
    Supports O(1) write for any index / key. Falls back to sequential write in last resort.
    """
