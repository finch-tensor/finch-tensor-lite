...
class Form(ABC):
    """
    A Form represents the invariants that must hold for the inputs to be valid
    for a given stage. It will typically be a combination of a grammar and a
    set of constraints on the inputs. Stages should inherit from a Form to
