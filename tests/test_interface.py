...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((operator.eq, finchlite.compare_equal, np.equal), np.equal),
        ((operator.ne, finchlite.compare_not_equal, np.not_equal), np.not_equal),
        ((operator.lt, finchlite.compare_less, np.less), np.less),
        ((operator.le, finchlite.compare_less_equal, np.less_equal), np.less_equal),
        ((operator.gt, finchlite.compare_greater, np.greater), np.greater),
        (
            (operator.ge, finchlite.compare_greater_equal, np.greater_equal),
            np.greater_equal,
        ),
    ],
)
