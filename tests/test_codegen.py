...
@pytest.mark.parametrize(
    ["compiler", "tabletype"],
    [
        pytest.param(CCompiler(), CHashTable, marks=pytest.mark.c_backend),
        pytest.param(
            asm.AssemblyInterpreter(), CHashTable, marks=pytest.mark.c_backend
        ),
